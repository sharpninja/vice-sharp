...
**Covered by:** FR: FR-CHIPSTATE-001; TEST: TEST-CHIPSTATE-001
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-PERF-RUNFRAME-001; TEST: TEST-PERF-RUNFRAME-001
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-CPUTICK-001; TEST: TEST-CPUTICK-001
**Status:** pending
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: BACKFILL-VIDEO-001, FR-VIC-001; TEST: TEST-VIC-CHECKPOINT-001, TEST-VIC-RC-001
**Status:** closed
Scope: layer-1+
...
**Covered by:** FR: ARCH-TRUEDRIVE-1541-002, BACKFILL-MEDIA-001; TEST: TEST-DRV-MOTOR-001, TEST-IEC-TIMING-001, TEST-TAPE-RAMP-001, TEST-TAPE-SENSE-001
**Status:** closed
Scope: layer-1+
...
**Covered by:** FR: FR-HOST-006, FR-UI-002, FR-UI-003; TEST: TEST-DRV-001, TEST-UI-001
**Status:** in_progress
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-DRV-005, FR-HOST-006; TEST: TEST-DRV-001, TEST-UI-001
**Status:** in_progress
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: ARCH-TRUEDRIVE-1541-002; TEST: TEST-DRV-MOTOR-001, TEST-IEC-TIMING-001
**Status:** closed
Scope: layer-1+
...
**Covered by:** FR: FR-DRVTRUE-001, FR-IECLOAD-001; TEST: TEST-DRVTRUE-001, TEST-DRVLIFE-001, TEST-IECELEC-001, TEST-IECLOAD-001
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-IECSPY-001; TEST: TEST-IECSPY-001
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-MED-004; TEST: TEST-MED-004
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-MED-003; TEST: TEST-MED-003
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-MED-002; TEST: TEST-MED-002
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-PACESEL-001; TEST: TEST-PACESEL-001
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-PUBSUB-001; TEST: TEST-PUBSUB-001
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
## TR-QA-TESTSILENCE-001

**Audio-producing tests self-mute the host process Windows audio session** — Test classes that drive the real WinMmAudioBackend (SidAudioWiring, WarpAudioDiscard, DemoWorkloadSpeedDiag, WinMmAudioThroughputDiag, ClockThroughputBenchmark) mute the current process Windows audio session (WASAPI ISimpleAudioVolume on the default session) for the duration of the class and restore the prior mute state on dispose, keeping a developer box silent during a run. Implemented with a raw function-pointer vtable COM helper, AOT and trim clean (no ComImport or reflection), that no-ops on non-Windows or headless hosts. Test infrastructure only; it changes nothing under test.
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-REVEXEC-001; TEST: TEST-REVEXEC-001, TEST-SNAPFULL-001
**Status:** pending
Scope: layer-1+
...
**Covered by:** FR: FR-SIDAUDIO-001; TEST: TEST-SIDAUDIO-001
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-SIDEBARUI-001; TEST: TEST-SIDEBARUI-001
**Status:** pending
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-SID-014; TEST: TEST-SID-002
**Status:** completed
Scope: layer-1+
...
**Covered by:** FR: FR-SNDREG-001; TEST: TEST-SNDREG-001
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-IECHOTPLUG-001, FR-SYSINDEP-001; TEST: TEST-IECHOTPLUG-001, TEST-SYSINDEP-001
**Status:** pending
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-TICKHIST-001; TEST: TEST-TICKHIST-001, TEST-TICKHIST-002
**Status:** completed
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: FR-UI-002, FR-UI-003; TEST: TEST-UI-001
**Status:** in_progress
Scope: layer-1+
**Acceptance Criteria:**
...
**Covered by:** FR: BACKFILL-VIDEO-001; TEST: TEST-VIC-CHECKPOINT-001, TEST-VIC-RC-001
**Status:** closed
Scope: layer-1+
...
**Covered by:** FR: BACKFILL-VIDEO-001, FR-VIC-008; TEST: TEST-VIC-CHECKPOINT-001, TEST-VIC-RC-001
**Status:** closed
Scope: layer-1+
