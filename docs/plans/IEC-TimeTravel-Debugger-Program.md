...
Status: PLAN (decision-complete). Branch base: `1cfbcb1`.
...
### S3 — Reverse execution (FR-REVEXEC-001, TR-REVEXEC-001)
...
### S4 — IEC trace recorder (TR-IECTRACE-001)
...
### S5 — IEC protocol decoder (TR-IECDECODE-001)
...
### S6 — IEC Scope panel (FR-IECMON-001)
...
### S7 — True-drive 1541 + faithful electrical model (FR-IECLOAD-001 part, TR-IECELEC-001)
