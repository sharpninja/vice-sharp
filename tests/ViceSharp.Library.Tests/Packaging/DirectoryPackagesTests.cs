...
/// Acceptance (AC-PKG-04): RomM.Client 1.0.1 and RomM.Client.Csdb 1.0.1 are pinned under CPM.
/// </summary>
...
public sealed class DirectoryPackagesTests
{
    ...
    /// <summary>AC-PKG-04: each RomM client package is pinned at exactly version 1.0.1.</summary>
    [Theory]
    [Trait("AC", "AC-PKG-04")]
    [InlineData("RomM.Client", "1.0.1")]
    [InlineData("RomM.Client.Csdb", "1.0.1")]
