...
/// <summary>
/// FR/TR: FR-VIC-002 / FR-VIC-003 / FR-VIC-008 / TEST-VIC-001
/// (BACKFILL-VIDEO-001 display mode selection).
...
/// property reports the abstract mode the chip is currently in. Pixel
/// routing is covered by VideoRendererTests.
/// </summary>
public sealed class VicIIDisplayModeTests
{
    ...
    /// <summary>
    /// FR/TR: FR-VIC-002 / TEST-VIC-001 (BACKFILL-VIDEO-001 display mode selection).
    ...
    /// <summary>
    /// FR/TR: FR-VIC-003 / TEST-VIC-001 (BACKFILL-VIDEO-001 display mode selection).
    ...
    /// <summary>
    /// FR/TR: FR-VIC-002 / FR-VIC-003 / TEST-VIC-001 (BACKFILL-VIDEO-001 display mode selection).
